...
switch(d){case "gtm.init":t&&od(20)}return Lj(r,t)};function Hj(a){return function(b){rj&&(Vb(b)||wj(a,"input",b))}}function Jj(a,b){wf(a,"event",1);wf(a,"ecommerce",1);wf(a,"gtm");wf(a,"eventModel");qi(b,function(){yf(a,"event");yf(a,"ecommerce");yf(a,"gtm");yf(a,"eventModel")});}
...
a.Cf&&y("did",a.Cf);var P=A+"/pagead/landing?"+z.join("&");Pb(P)}}var c=!!a.Od,d=!!a.oa,e=a.P,f=void 0===a.Nc?{}:a.Nc,h=void 0===a.Tc?!0:a.Tc,k=ah(),l=k.gclid||"",n=k.gclsrc,q=k.dclid||"",p=k.gbraid||"",r=!c&&((!l||n&&"aw.ds"!==n?!1:!0)||p),t=Jd();if(r||t)t?Vd(function(){b();I(G.D)||Ud(function(u){return b(!0,u.nh)},G.D)},[G.D]):b()}function Qk(a,b){var c=a&&!I(G.D);return b&&c?"0":b}
var ol=function(){if(!I(G.D)||!nl&&!kk(""))return!1;nl=!0;var a=m.featurePolicy;if(a&&ua(a.features)&&-1!==a.features().indexOf("conversion-measurement"))return!0;return!1},pl=function(a){return!(void 0===a||null===a||0===(a+"").length)},ql=function(a,b){var c;if(2===b.ma)return a("ord",Ba(1E11,1E13)),!0;if(3===b.ma)return a("ord","1"),a("num",Ba(1E11,
1E13)),!0;if(4===b.ma)return pl(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.ma)c="1";else if(6===b.ma)c=b.je;else return!1;pl(c)&&a("qty",c);pl(b.Oc)&&a("cost",b.Oc);pl(b.transactionId)&&a("ord",b.transactionId);return!0},tl=function(a,b,c,d){function e(N,Q,O){t.hasOwnProperty(N)||(Q=String(Q),r.push(";"+N+"="+(O?Q:rl(Q))))}function f(N,Q){Q&&e(N,Q)}var h=a.Rd,k=a.ne,l=a.protocol,n=a.Wd;l+=k?"//"+h+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";var q=";",p=!1;
p=!0;I(G.D)||n||!a.oa&&!p||(l="https://ade.googlesyndication.com/ddm/activity",q="/",k=!1);var r=[q,"src="+rl(h),";type="+rl(a.Vd),";cat="+rl(a.Pb)],t=a.th||{};Fa(t,function(N,Q){r.push(";"+rl(N)+"="+rl(Q+""))});if(ql(e,a)){pl(a.cd)&&e("u",a.cd);pl(a.bd)&&e("tran",a.bd);e("gtm",fk());Jd()&&!n&&(e("gcs",Td()),c&&e("gcu","1"));f("gdpr_consent",Jk()),f("gdpr",Lk());
"1"===Fg(!1)._up&&e("gtm_up","1");!1===a.gh&&e("npa","1");if(a.Qd){var u=void 0===a.oa?!0:!!a.oa,v=rh("dc",a.Ba,u),x=!1;v&&v.length&&(e("gcldc",v.join(".")),x=!0);var z=!0;z=k;if(z)if(sl&&!x&&wh(a.Ba)){var w=rh("gb",a.Ba,u);w.length&&e("gclgb",w.join("."));var y=uh(u);y&&e("gacgb",y)}else{var A=rh("aw",a.Ba,u);A&&A.length&&e("gclaw",A.join("."));var C=th(u);C&&e("gac",C)}hg({prefix:a.Ba,
fb:a.qh,domain:a.ph,flags:a.Bi});var F=dg[eg(a.Ba)];F&&e("auiddc",F)}pl(a.fe)&&e("prd",a.fe,!0);pl(d)&&e("em",d,!0);Fa(a.se,function(N,Q){e(N,Q)});r.push(b||"");var D=ol();D&&r.push(";ps=1");if(pl(a.Uc)){var H=a.Uc||"";I(G.D)||n||!a.oa||(H=qe(H));e("~oref",H)}var P=l+r.join("")+"?";k?Gb(P,a.onSuccess):Hb(P,a.onSuccess,a.onFailure);D&&Hb("https://"+h+".fls.doubleclick.net/activityi;register_conversion=1"+
r.join("")+"?");}else B(a.onFailure)},ul=function(a,b,c){var d=!1;d&&a.ra?We(a.ra,[],function(e){tl(a,b,c,e)}):tl(a,b,c)},sl=!1;sl=!0;var rl=encodeURIComponent,nl=!1,vl=function(a,b){!Jd()||a.Wd?
ul(a,b):Vd(function(){ul(a,b);I(G.D)||Ud(function(){ul(a,b,!0)},G.D)},[G.D])};var Rl=function(){var a=!0;Mk(7)&&Mk(9)&&Mk(10)||(a=!1);var b=!0;b=!1;b&&!Ql()&&(a=!1);return a},Ql=function(){var a=!0;Mk(3)&&Mk(4)||(a=!1);return a};var om=!1;function pm(){var a=Ye;return a.gcq=a.gcq||new qm}
...
function Kr(a,b){}var V={g:{}};V.g.ctv=["google"],function(){(function(a){V.__ctv=a;V.__ctv.h="ctv";V.__ctv.m=!0;V.__ctv.priorityOverride=0})(function(){return"416"})}();

V.g.flc=[],function(){function a(c,d){d=d?d.slice(0,-1):void 0;vl(c,d)}var b=!1;(function(c){V.__flc=c;V.__flc.h="flc";V.__flc.m=!0;V.__flc.priorityOverride=0})(function(c){var d=!c.hasOwnProperty("vtp_enableConversionLinker")||!!c.vtp_enableConversionLinker,e=Wo(c.vtp_customVariable||[],"key",
"value")||{};var q={Pb:c.vtp_activityTag,Qd:d,Ba:c.vtp_conversionCookiePrefix||void 0,Oc:void 0,ma:{UNIQUE:3,SESSION:4}[c.vtp_ordinalType]||2,Rd:c.vtp_advertiserId,Vd:c.vtp_groupTag,onFailure:c.vtp_gtmOnFailure,onSuccess:c.vtp_gtmOnSuccess,Uc:c.vtp_useImageTag?void 0:c.vtp_url,protocol:"",je:void 0,
ne:!c.vtp_useImageTag,sessionId:c.vtp_sessionId,bd:c.vtp_transactionVariable,transactionId:void 0,cd:c.vtp_userVariable,ra:c.vtp_userDataVariable,se:e},p=!1;var r=!(I(G.D)||p)&&void 0!=go(G.O)&&!1!==go(G.O);q.oa=r;if(c.vtp_enableAttribution){var t=c.vtp_attributionFields||[];if(t.length){J("//www.gstatic.com/attribution/collection/attributiontools.js",
function(){a(q,L("google_attr").build([Wo(t,"key","value")||{}]))},c.vtp_gtmOnFailure);return}}a(q)})}();
...
V.g.r=["google"],function(){(function(a){V.__r=a;V.__r.h="r";V.__r.m=!0;V.__r.priorityOverride=0})(function(a){return Ba(a.vtp_min,a.vtp_max)})}();
...
"category")),eventAction:String(W("vtp_eventAction","action")),eventLabel:H(String,W("vtp_eventLabel","label")),eventValue:H(Ia,W("vtp_eventValue","value"))};l(S,M,!1);D("send",M);}else if("TRACK_SOCIAL"==p.vtp_trackType){}else if("TRACK_TRANSACTION"==p.vtp_trackType){}else if("TRACK_TIMING"==p.vtp_trackType){}else if("DECORATE_LINK"==p.vtp_trackType){var zb=go("gtm.element",1);zb&&A(function(){var oa=xi(),X=oa&&oa.getByName&&oa.getByName(F),Wa=sb(L("gaplugins").Linker,X);zb&&zb.href&&(zb.href=Wa.decorate(zb.href,p.vtp_useHashDecorateLink),B(p.vtp_gtmOnSuccess))});}else if("DECORATE_FORM"==
...
V.g.ga=["google"],function(){var a,b;(function(c){V.__ga=c;V.__ga.h="ga";V.__ga.m=!0;V.__ga.priorityOverride=0})(function(c){function d(T){var K=[].slice.call(arguments,0);K[0]=u+K[0];r.push(K)}function e(T,K){void 0!==c[K]&&d(T,c[K])}function f(T,K){void 0!==c[K]&&d(T,Number(c[K]))}function h(T,K){if(p(K))for(var S=0;S<K.length;S++)d(T,K[S])}function k(T,K,S){if(p(K))for(var W=0;W<K.length;W++){for(var M=[T],Y=K[W],ha=0;ha<S.length;ha++)M.push(Y[S[ha]]);
d.apply(this,M)}}function l(T,K){void 0!==c[K]&&d("_set",T,c[K])}function n(T,K){return void 0===K?K:T(K)}function q(T,K){void 0!==K&&(v+="&"+T+"="+K)}var p=xa,r=L("_gaq",[],!1),t=!1,u="";void 0==c.vtp_trackerName?u="gtm"+lf()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",fk(!0));
...
h("_addIgnoredRef",c.vtp_ignoredRef);h("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var x=function(T,K,S){for(var W=K.length-1;0<=W;W--){var M=K[W].split("=");if(M[0]===T)return M[1]||"1"}for(var Y=S.length-1;0<=Y;Y--){var ha=S[Y].split("=");if(ha[0]===T)return ha[1]||"1"}},z=pe(co()),w=ne(z,"query").split("&"),y=c.vtp_allowAnchor?ne(z,"fragment").split("&"):[];q("gclid",x("gclid",y,w));q("gclsrc",x("gclsrc",y,w));q("dclid",x("dclid",y,w));d("_set","campaignParams",
...
var N=go("gtm.element",1);N&&r.push(function(){var T=L("_gat")._getTrackerByName(u.slice(0,-1)),K=N.href;if(K){var S=/(.*)([?&#])(?:__utma=.*__utmk=[^&]*)(?:&?)(.*)/.exec(K);S&&3<=S.length&&(K=S[1]+(S[3]?S[2]+S[3]:""));N.href=T._getLinkerUrl(K,c.vtp_useHashDecorateLink);B(c.vtp_gtmOnSuccess)}});}else if("DECORATE_FORM"==c.vtp_trackType){}else d("_trackPageview");
h("_cookiePathCopy",c.vtp_cookiePathCopy);var Q=function(){L("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,J(Eh("https","http","://stats.g.doubleclick.net/dc.js",t),Q,c.vtp_gtmOnFailure));else if(!a){var O=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;J(Eh("https://ssl","http://www",O,t),Q,c.vtp_gtmOnFailure)}})}();
